...
namespace Indra\Revisor\Facades {
     ...
     */        class Revisor {
         ...
         *
         * @static 
         */        public static function schemaCreate($table, $callback)
        {
                        /** @var \Indra\Revisor\Revisor $instance */
                        return $instance->schemaCreate($table, $callback);
        }
                    /**
         * 
         *
         * @static 
         */        public static function getVersionsTableNameFor($table)
        {
                        return \Indra\Revisor\Revisor::getVersionsTableNameFor($table);
        }
                    /**
         * 
         *
         * @static 
         */        public static function getLiveTableNameFor($table)
        {
                        return \Indra\Revisor\Revisor::getLiveTableNameFor($table);
        }
            }
    }
