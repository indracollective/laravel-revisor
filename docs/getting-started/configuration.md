...
After publishing the configuration during installation, The following configuration file will be available to in you at `config/revisor.php.` The config file is thoroughly documented for your convenience.
